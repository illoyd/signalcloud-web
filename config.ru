...
use Rack::Rewrite do
  ...
  %w{ api security platforms ideas/iap ideas/cards ideas/packages ideas/appointments policies/terms policies/privacy policies/promise policies/aup policies/dmca }.each do |key|
